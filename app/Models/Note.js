...
export class Note{
  ...
  <div class="col-6 d-flex align-items-center justify-content-center g-0">
    <textarea name="body" id="noteText" cols="100" rows="19" class="rounded" placeholder="Your notes go here!" onblur="app.notesController.updateNote('${this.id}')">${this.body}</textarea>
  </div>
